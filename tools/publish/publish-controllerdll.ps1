...
$projectPath = Join-Path $repoRoot "ControllerDll\ControllerDll.csproj"

$outDir = Join-Path $repoRoot "artifacts\publish\ControllerDll\$Version"
$downloadsDir = Join-Path $siteRoot "downloads"
$zipName = "ControllerDll-$Version.zip"
$zipPath = Join-Path $downloadsDir $zipName
$latestPath = Join-Path $downloadsDir "ControllerDll-latest.zip"
